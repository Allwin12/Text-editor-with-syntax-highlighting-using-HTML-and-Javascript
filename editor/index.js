...
function loadDiffSample() {
	...
	xhr('https://github.com/microsoft/monaco-editor/blob/master/website/index/samples/diff.lhs.txt', function(err, data) {
		if (err) {
			return onError();
		}
		lhsData = data;
	...
	xhr('https://github.com/microsoft/monaco-editor/blob/master/website/index/samples/diff.rhs.txt', function(err, data) {
		if (err) {
			return onError();
		}
		rhsData = data;
